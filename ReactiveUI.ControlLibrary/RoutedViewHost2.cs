...
{
    /// <summary>
    /// Almost the same than original RoutedViewHost expect that it inherits from TransitioningContentControl3
    ...
    public class RoutedViewHost2 : TransitioningContentControl2, IActivatableView, IEnableLogger
    {
        /// <summary>
        /// The router dependency property.
        /// </summary>
        public static readonly DependencyProperty RouterProperty =
            DependencyProperty.Register("Router", typeof(RoutingState), typeof(RoutedViewHost2), new PropertyMetadata(null));

        /// <summary>
        /// The default content property.
        /// </summary>
        public static readonly DependencyProperty DefaultContentProperty =
            DependencyProperty.Register("DefaultContent", typeof(object), typeof(RoutedViewHost2), new PropertyMetadata(null));

        /// <summary>
        /// The view contract observable property.
        /// </summary>
        public static readonly DependencyProperty ViewContractObservableProperty =
            DependencyProperty.Register("ViewContractObservable", typeof(IObservable<string>), typeof(RoutedViewHost2), new PropertyMetadata(Observable.Return<string>(default)));

        /// <summary>
        /// Initializes a new instance of the <see cref="RoutedViewHost2"/> class.
        /// </summary>
        public RoutedViewHost2()
        {
#if NETFX_CORE
